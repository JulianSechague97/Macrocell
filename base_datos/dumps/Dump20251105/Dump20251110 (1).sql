...
INSERT INTO `empleados` VALUES (1,NULL,'Administrador Principal','admin@macrocell.com',NULL,'2801','admin',0),(2,'12345678','Juan Perez','juan@example.com','3001234567','123456','empleado',0),(3,'1120498228','johan camacho','johancamacho079@gmail.com','3209917736','28Deenerode2003','admin',0);
...
INSERT INTO `venta` VALUES (1,1,NULL,'2025-11-10 19:49:31',495.00);
...
CREATE TABLE `venta_producto` (
  ...
  CONSTRAINT `fk_vp_producto` FOREIGN KEY (`ID_producto`) REFERENCES `producto` (`ID_producto`) ON UPDATE CASCADE,
  CONSTRAINT `fk_vp_venta` FOREIGN KEY (`ID_venta`) REFERENCES `venta` (`ID_venta`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-10 20:24:47
